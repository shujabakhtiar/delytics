...
const data = [
    { name: 'Delivered', value: 850, color: '#10B981' }, // Success
    { name: 'In Transit', value: 300, color: '#3B82F6' }, // Primary
    { name: 'Pending', value: 100, color: '#F59E0B' },   // Warning
    { name: 'Failed', value: 34, color: '#EF4444' },     // Error
];
